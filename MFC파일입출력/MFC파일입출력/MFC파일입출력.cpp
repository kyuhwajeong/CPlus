...
// MFC파일입출력.cpp : 응용 프로그램에 대한 클래스 동작을 정의합니다.
//
...
CMFC파일입출력App::CMFC파일입출력App()
{
	...
	SetAppID(_T("MFC파일입출력.AppID.NoVersion"));

	// TODO: 여기에 생성 코드를 추가합니다.
	// InitInstance에 모든 중요한 초기화 작업을 배치합니다.
}

// 유일한 CMFC파일입출력App 개체입니다.
...
BOOL CMFC파일입출력App::InitInstance()
{
